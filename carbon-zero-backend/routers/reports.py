...
data = {
    ...
    "forestEstimation": [
        [
            {"treeType": "Bamboo", "soilType": "type1",
                "noOfTrees": 50, "coverageArea": 50, "timeToGrow": 123},
            {"treeType": "OOO", "soilType": "type1", "noOfTrees": 50,
                "coverageArea": 50, "timeToGrow": 123},
            {"treeType": "Bamboo", "soilType": "type1",
                "noOfTrees": 50, "coverageArea": 50, "timeToGrow": 123},
            {"treeType": "Bamboo", "soilType": "type1",
                "noOfTrees": 50, "coverageArea": 50, "timeToGrow": 123},
        ...
        [
            {"treeType": "Bamboo", "soilType": "type1",
                "noOfTrees": 50, "coverageArea": 50, "timeToGrow": 123},
            {"treeType": "BBB", "soilType": "type1", "noOfTrees": 50,
                "coverageArea": 50, "timeToGrow": 123},
            {"treeType": "Bamboo", "soilType": "type1",
                "noOfTrees": 50, "coverageArea": 50, "timeToGrow": 123},
        ],
        [
            {"treeType": "Bamboo", "soilType": "type1",
                "noOfTrees": 50, "coverageArea": 50, "timeToGrow": 123},
            {"treeType": "CCC", "soilType": "type1", "noOfTrees": 50,
                "coverageArea": 50, "timeToGrow": 123},
            {"treeType": "Bamboo", "soilType": "type1",
                "noOfTrees": 50, "coverageArea": 50, "timeToGrow": 123},
        ]
    ...
    "emissionBreakDown": [
        {"amountOfEmission": 1000, "causeOfEmission": "Energy Consumption",
            "suggestions": "Use energy effectify"},
        {"amountOfEmission": 1000, "causeOfEmission": "Energy Consumption",
            "suggestions": "Use energy effectify"},
    ],
    "energyBreakdown": [
